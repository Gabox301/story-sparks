...
const ExtendStoryInputSchema = z.object({
  ...
  userInput: z.string().describe('The user input to guide the story extension.'),
});
...
export async function extendStory(input: ExtendStoryInput): Promise<ExtendStoryOutput> {
